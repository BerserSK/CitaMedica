            ...
            <div class="card-body px-lg-5 py-lg-5">
                ...
                @else
                    <div class="text-center text-muted mb-4">
                        <small>Ingresar con tus credenciales para acceder al sistema.</small>
                    </div>
                @endif
              ...
              <form role="form" method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Conjtraseña" type="password" name="password" required autocomplete="Current-password">
                  </div>
                </div>
